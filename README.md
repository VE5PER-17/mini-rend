...
**里程碑 1 · 搭工具链** — 开发机 A 已装完(vcpkg + GLFW 3.4 + glm 1.0.3 + VS Code 插件);开发机 B 待装。
**下一步:** 冒烟测试(最小 CMake 工程链接 GLFW+glm,用 MSVC 跑出窗口,验证整条工具链通路)。

> _更新于 2026-07-13。每次同步进度时本段会随之刷新,详细进度见 [PROGRESS.md](PROGRESS.md)。_
